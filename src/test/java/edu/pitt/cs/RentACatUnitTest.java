...
public class RentACatUnitTest {
	...
	public void setUp() throws Exception {
		...
		//Mockito.when(c2.renameCat()).thenReturn(true);
	...
	public void testRentCatFailureNumCats3() {
    	...
    	Mockito.when(c2.getName()).thenReturn("Old Deuteronomy");
    	Mockito.when(c2.getRented()).thenAnswer(inv -> rented.get());
    	Mockito.doAnswer(inv -> { rented.set(true); return null; }).when(c2).rentCat();
    	Mockito.doAnswer(inv -> { rented.set(false); return null; }).when(c2).returnCat();
	...
	public void testReturnCatNumCats3() {
		// TODO: Fill in
		AtomicBoolean rented = new AtomicBoolean(true); // precondition: c2 is rented
